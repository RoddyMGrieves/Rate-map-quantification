...
%% #################### computation time
    ...
    ax1 = axes('Units','pixels','Position',[xnow ynow-20 300 160-sep],'Color','none','Clipping','off'); 
        ...
        text(0.99,0.1,'N = 256 cells','Units','normalized','HorizontalAlignment','right','VerticalAlignment','top')
...
%% #################### Heatmap of error by binsize and smoothing
    ...
    ax1 = axes('Units','pixels','Position',[xvec(2)+30 yvec(1) siz siz],'Color','none','Clipping','off');         
        ...
        [~,leg] = legendflex([p1 s1]...
            ,{'trajectory','spikes'}...
            ,'anchor',{'e','e'},'ncol',1,'box','off','buffer',[100,0],'xscale',1,'fontsize',9); 
